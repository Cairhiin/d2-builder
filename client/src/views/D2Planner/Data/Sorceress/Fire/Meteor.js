const Meteor = {
  ...
  data: {
    "Damage": function(slvl, dlvl=[0, 0, 0]) {
      ...
      let min = 83*slvl - 811;
      let max = 85*slvl - 793;
      if (slvl < 29) { min = 81*slvl - 755; max = 83*slvl - 737 };
      if (slvl < 23) { min = 79*slvl - 711; max = 81*slvl - 693 };
      if (slvl < 17) { min = 39*slvl - 71; max = 41*slvl - 53 };
      if (slvl < 9) { min = 23*slvl + 57; max = 25*slvl + 75 };
    ...
    "Average Damage": function(slvl, dlvl=[0, 0, 0]) {
      ...
      let min = 48*slvl - 104;
      let max = 48*slvl - 24;
      if (slvl < 17) { min = 40*slvl + 24; max = 40*slvl + 104 }
      if (slvl < 9) { min = 32*slvl + 88; max = 32*slvl + 168 }
      return { min: dmgMultiplier*min, max: dmgMultiplier*max };
    },
    "Mana Cost": () => 2.5,
    "Radius": () => 4,
